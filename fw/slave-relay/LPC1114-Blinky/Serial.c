...
void SER_init (void) {
  ...
  LPC_SYSCON->UARTCLKDIV     =  (4UL <<  0);    /* UART clock =  CCLK / 4   ! 4 before  */

  LPC_UART->LCR = 0x83;                   /* 8 bits, no Parity, 1 Stop bit    */
  LPC_UART->DLL = 6;                      /* 115200 Baud Rate @ 12.0 MHZ PCLK */
  LPC_UART->FDR = (12<<4) | (1<<0);                   /* FR 1.627, DIVADDVAL 5, MULVAL 8  */
